package com.codersworld.rklib.indicator
...
class CirclePagerIndicator: FrameLayout {
    ...
    private fun init(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) {
        val a = context.theme.obtainStyledAttributes(attrs,
            R.styleable.CirclePagerIndicator, 0, 0)
        try {
            indicatorSpacing = a.getDimensionPixelSize(R.styleable.CirclePagerIndicator_indicator_spacing, 0)
        } finally {
            a.recycle()
        }
        LayoutInflater.from(context).inflate(R.layout.rk_pager_indicator, this, true)
