...
public class RoundCornerView extends ShapeView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RoundCornerView);
            topLeftRadius = attributes.getDimensionPixelSize(R.styleable.RoundCornerView_shape_roundCorner_topLeftRadius, (int) topLeftRadius);
            topRightRadius = attributes.getDimensionPixelSize(R.styleable.RoundCornerView_shape_roundCorner_topRightRadius, (int) topRightRadius);
            bottomLeftRadius = attributes.getDimensionPixelSize(R.styleable.RoundCornerView_shape_roundCorner_bottomLeftRadius, (int) bottomLeftRadius);
            bottomRightRadius = attributes.getDimensionPixelSize(R.styleable.RoundCornerView_shape_roundCorner_bottomRightRadius, (int) bottomRightRadius);
            borderColor = attributes.getColor(R.styleable.RoundCornerView_shape_roundCorner_borderColor, borderColor);
            borderWidthPx = attributes.getDimensionPixelSize(R.styleable.RoundCornerView_shape_roundCorner_borderWidth, (int) borderWidthPx);
            attributes.recycle();
        }
